...
if __name__ == '__main__':
    ...
    layers = [
        ...
        Dense(name = 'Hidden Layer 1', layer_size = 128, activation = 'Tanh'),
        Dense(name = 'Hidden Layer 2', layer_size = 128, activation = 'Tanh'),
        Dense(name = 'Hidden Layer 3', layer_size = 128, activation = 'Tanh'),
        Dense(name = 'Hidden Layer 4', layer_size = 128, activation = 'Tanh'),
        Dense(name = 'Hidden Layer 5', layer_size = 128, activation = 'Tanh'),
        Dense(name = 'Last_Layer', layer_size = 10) #, activation = 'Softmax')
    ]

    # Best model chosen from sweep 
    model = NeuralNetwork(
        layers = layers, 
        batch_size = 512, 
        optimiser = 'Nadam', 
